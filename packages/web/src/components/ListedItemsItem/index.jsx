    ...
    <div className="col-lg-3 col-sm-6 col-xs-12">
        <div className={clsx(
            ...
            <div className="wraper">
                <NavLink to="/itemdetails" className="image-wrapper"><img src={imgBig} alt="" /></NavLink>
                <div className="info-wrapper">
                    ...
                    <span><span className={isLightMode ? "text-muted" : "g-text"} >{t("common.price")}</span> {price} ETH <span className={isLightMode ? "text-muted ml-15" : "g-text ml-15"}>1 {t("common.of")} 10</span></span> 
                    <div className={isLightMode ? "text-dark pricing" : "pricing"}>{t("common.highestBid")} : <span className="ml-15">{bid} ETH</span> </div> 
                    <div className="admire">
                        <div className={isLightMode ? "adm text-muted" : "adm"}><i className="fa fa-clock-o"></i> 6 Hours Ago</div>
                        <div className={isLightMode ? "adm text-muted" : "adm"}><i className="fa fa-heart-o"></i>134 {t("common.like")}</div>
                    </div>
                </div>
            </div>
        </div>
